              ...
              <div class="tab-content">
                ...
                <div class="tab-pane active show" id="settings">
                  <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="avatar" class="col-sm-2 control-label">Choose a profile picture:</label>
                        <div class="col-sm-10">    
                    ...
                    <div class="form-group">
                      <label for="inputSkills" class="col-sm-2 control-label">Passport (leave blank if not changing)</label>
