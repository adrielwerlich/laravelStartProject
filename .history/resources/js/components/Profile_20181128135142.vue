      ...
      <div class="col-md-12 mt-3">
        ...
        <div class="card card-widget widget-user">
          ...
          <div
            ...
            style="background: url('/img/back4.jpg') center center;"
          >
          <div id="floatRight" style="float:right !important;">
            <h3 class="widget-user-username">Elizabeth Pierce</h3>
            <h5 class="widget-user-desc">Web Designer</h5>
          </div>
          </div>
          <div class="widget-user-image">
            <img class="img-circle" src="/img/avatar800-800.png" alt="User Avatar">
          </div>
        ...
        <!-- ########### HEADER ABOVE ########### -->
        <!-- ############# PROFILE PAGE BELOW ################### -->
        <div class="col-md-12" id="userProfilePanel">
          <div class="card">
                ...
                <div class="tab-pane" id="activity">
                  ...
                  <div class="post">
                    ...
                    <p>
                      ...
                      tools to help create filler text for everyone from VEGAN lovers
                ...
                <div class="tab-pane active show" id="settings">
                  <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">    
                            <input type="file" @change="updateProfilePhoto" id="avatar" name="avatar" accept="image/png, image/jpeg">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                      <label for="inputSkills" class="col-md-12 control-label">Passport (leave blank if not changing)</label>
                    ...
                    <div class="form-group">
                      <div class="col-sm-offset-2 col-sm-10">
                        <button type="submit" @click.prevent="updateProfile" class="btn btn-danger fas fa-circle-plus">Update</button>
                      </div>
                    </div>
                  </form>
                </div>
...
export default {
  ...
  created(){
      axios.get('api/profile').then(userProfile => {
        // debugger
        this.form.fill(userProfile.data)
  ...
  methods:{
      ...
      updateProfilePhoto(event) {
        //   console.log('event', event)
          ...
          if (img['size'] < 2111775){
              reader.onloadend = r => {
                //   console.log('reader.onloadend ', r.currentTarget.result)
                //   console.log('reader.onloadend ', reader.result)
                  this.form.photo = reader.result
              }
              reader.readAsDataURL(img)
          } else {
              swal({type:'error', title:'try a smaller image', text:'file too large'})
          }
