      ...
      <div class="modal-dialog modal-dialog-center" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 v-show="!editMode" class="modal-title" id="addNewUserLabel"> Register New User </h5>
            <h5 v-show="editMode" class="modal-title" id="addNewUserLabel"> Edit\Update User </h5>
          ...
          <div class="modal-footer">
            ...
            <button v-show="!editMode" type="submit" class="btn btn-primary">Create User <i class="fas fa-plus-circle"></i></button>
            <button v-show="editMode" type="submit" class="btn btn-success">Update User <i class="fas fa-plus-circle"></i></button>
          </div>
...
<script>
    export default {
        ...
        created(){
          ...
          VueEventsController.$on('userListChanged', () => {
            this.fetchUsers()
          })
        },
        ...
        methods:{
          updateUser(){
            ...
            .then(result => {
              ...
              swal( 'Updated!', 'Update done!', 'success')
              this.$Progress.finish()
              VueEventsController.$emit('userListChanged')
            }).catch(err => {
              console.error(err)
              this.$Progress.fail()
            })
